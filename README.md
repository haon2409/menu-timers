...
Build the standalone app:chmod +x build_timers.sh
./build_timers.sh


Find the built app (TimerApp.app) in the project root.
...
Run TimerApp.app from the project root or copy it to /Applications/ and double-click.
...
Build issues: Confirm PyObjC and PyInstaller are installed; check terminal output for errors.
